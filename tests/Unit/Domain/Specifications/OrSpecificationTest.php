...
use App\Domain\Specifications\OrSpecification;
...
class OrSpecificationTest extends TestCase
{
    ...
    public function test_is_satisfied_by_returns_true_when_both_specifications_are_satisfied(): void
    {
        ...
        $this->assertTrue($orSpec->isSatisfiedBy($offer));
    }

    public function test_is_satisfied_by_returns_true_when_first_specification_is_satisfied(): void
    {
        $offer = Offer::factory()->published()->create();
    ...
    public function test_is_satisfied_by_returns_true_when_second_specification_is_satisfied(): void
    {
    ...
    public function test_is_satisfied_by_returns_false_when_both_specifications_fail(): void
    {
        ...
        $this->assertFalse($orSpec->isSatisfiedBy($offer));
    }
}
